  ...
  return (
    <div>
      <nav className="aside__nav">
        <ul>
          <li>
            <a href='mailto: sandra.larrosa88@gmail.com'>
              <img className='iconRRSS' src={mail} alt='icon__email'></img>
            </a>
          </li>
          <li>
            <a href='https://github.com/SandraLarrosa'>
              <img className='iconRRSS' src={github} alt='icon__github'></img>
            </a>
          </li>
          <li>
            <a href='https://www.linkedin.com/in/alexandralopezlarrosa/'>
              <img
                className='iconRRSS'
                src={linkedin}
                alt='icon__linkedin'
          ...
          <li>
            <a href='https://twitter.com/AlexandraLopez'>
